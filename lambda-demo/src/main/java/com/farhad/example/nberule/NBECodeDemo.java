...
import com.farhad.example.nberule.NBECodeDemo.User.Id;
    ...
    static class UserService {
        ...
        public UserWithProfile getUserWithProfile(User.Id userId) {
            return userRepository.findById(userId)
                    .map(u -> userProfileRepository.findById(userId)
                                    .map(up -> UserWithProfile.of(u, up))
                                    .orElse(UserWithProfile.of(u,UserProfile.defaultProfile())))
