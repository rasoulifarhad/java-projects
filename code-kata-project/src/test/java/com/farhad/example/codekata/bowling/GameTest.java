...
public class GameTest {
    ...
    public void testFourThrowsNoMark() {
        ...
        assertEquals(9, g.scorer.scoreForFrame(1));
        assertEquals(18, g.scorer.scoreForFrame(2));
    ...
    public void testSimpleSpare() {
        ...
        g.add(7);
        g.add(3);
        assertEquals(13, g.scorer.scoreForFrame(1));
        assertEquals(2, g.getCurrentFrame());
    }
    ...
    public void testSimpleStrike() {
        ...
        g.add(3);
        g.add(6);
        assertEquals(19, g.scorer.scoreForFrame(1));
