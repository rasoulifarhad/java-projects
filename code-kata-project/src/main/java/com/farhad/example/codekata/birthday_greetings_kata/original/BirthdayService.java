...
public class BirthdayService {
    ...
    public void sendGreetings(String fileName, LocalDate date, String smtpHost, int smtpPort) throws IOException, ParseException, AddressException, MessagingException {
