...
public class Inventory {
	...
	public void addGuitar(String serialNumbeer, double price, String numStrings, Builder builder, String model, Type type,
			Wood backWood,
			Wood topWood) {
		guitars.add(new Guitar(serialNumbeer, price, new GuitarSpec(numStrings, builder, model, type, backWood, topWood)));
	}
